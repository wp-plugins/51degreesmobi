...
function _H32($useragent) {
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(47863,176122,119050,913, $ua, '17595-17296-18215-18092');
  }
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(47863,355621,119050,913, $ua, '17595-17297-18215-18092');
  }
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(47863,607733,119050,913, $ua, '17595-18207-18215-18092');
  }
  ...
  $ua = 'AppleCoreMedia/1.0.0.12C3104 (Macintosh; U; Intel Mac OS X 10_8_2; en_us)';
  $ns = E32($useragent, $ua, $ls);
  if ($ns <= $ls) {
    if ($ns < $ls) {
      unset($dl);
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(47863,126201,119050,913, $ua, '17595-18120-18215-18092');
  }
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(44218,95563,119050,913, $ua, '15364-7133-18215-18092');
  }
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(116374,75464,119050,913, $ua, '12280-17779-18215-18092');
  }
