...
function _H63($useragent) {
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(18088,17017,4732,18092, 'Opera/9.50 (J2ME/MIDP; Opera Mini/v4.2.1141/20.2707; U; en)');
    $ls = $ns;
  }
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(12355,5567,18406,18092, 'Opera/9.80 (BREW; Opera Mini/5.43/26.1521; U; en) Presto/2.8.119 320X240 LG VN250');
    $ls = $ns;
  }
